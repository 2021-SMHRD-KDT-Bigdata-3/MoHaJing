		...
		<div class="col-lg-8 col-md-8">
			<div class="row d-flex align-items-center justify-content-center" style="height: 300px;">
				<form
					...
					id="myForm" action="${cpath}/${mapping}" method="post" style="font-family: 'Gowun Dodum', sans-serif; font-size: 16px; color: black;">
					...
					<div class="form-group col-md-12">
						<input type="text" class="form-control" id="name" name="id"
							...
							onblur="this.placeholder = 'ID'" style="border : none; border-bottom-style : solid; background-color : #f4f4f4;">
					</div>
					<div class="form-group col-md-12">
						<input type="password" class="form-control" id="name" name="pw"
							placeholder="PASSWARD" onfocus="this.placeholder = ''"
							onblur="this.placeholder = 'PASSWARD'" style="border : none; border-bottom-style : solid; background-color : #f4f4f4;">
					</div>
					<div class="form-group col-md-12">
						<input type="text" class="form-control" id="name" name="name"
							placeholder="이름" onfocus="this.placeholder = ''"
							onblur="this.placeholder = '이름'" style="border : none; border-bottom-style : solid; background-color : #f4f4f4;">
					</div>
					<div class="form-group col-md-12">
						<input type="text" class="form-control" id="name" name="age"
							placeholder="나이" onfocus="this.placeholder = ''"
							onblur="this.placeholder = '나이'" style="border : none; border-bottom-style : solid; background-color : #f4f4f4;">
					</div>
