...
<body>
   ...
   <section class="top-btn-area">
	...
	<tr height="100px" style="border-bottom: 1px solid; border-color: rgba(200, 200, 200, 0.7);">
		...
		<td style="padding-right:10px;padding-left:40px;"><a href="javascript:goJoin()" class="btn-reply text-uppercase" target="_blank" style="font-weight: bold;"><butten>신청</butten></a></td>
	</tr>
	<tr height="100px" style="border-bottom: 1px solid; border-color: rgba(200, 200, 200, 0.7);">
